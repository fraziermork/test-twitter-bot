    ...
    t.get('search/tweets', {q: searchQuery ,result_type: 'recent', lang: 'en', count: 10}, function(err, data, response){
      ...
      for(var i = 0; i < tweets.length; i++) {
        ...
        if(!tweetId[currentTweet.id_str]){
          ...
          // tweetObj.location = currentTweet.location;
          // console.log('LOCATION: ' + currentTweet.entities.location);
...
searchHashTag();
  ...
  searchMentions();
//input searchquery here

// module.exports = exports = (searchREST);

//tweet data
// reply functions / routes
